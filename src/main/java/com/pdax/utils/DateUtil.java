...
public class DateUtil {
    ...
    public static String getCurrentMilliDateTime() {
        ...
        return datestr +"."+  String.valueOf(date).substring(String.valueOf(date).length() - 3);
    }
    /**
     * 获取当前日期时间
     * @return
     ...
     * @return
     */
    public static String timestampToDateTime(String date) throws ParseException {
        SimpleDateFormat df = new SimpleDateFormat(DateUtil.DATE_TIME_FORMAT);
        return df.format(new Date(Long.valueOf(date))) +"."+ date.substring(date.length() - 3);
    }
    /**
     * 比较两个时间的时间 差，毫秒算
     ...
     */
    public static long dateDiffDateTime(String startTime,String endTime) throws ParseException {
        return DateUtil.dateDiffDateTime(Long.valueOf(startTime), Long.valueOf(endTime));
    }
     ...
     * @throws ParseException
     */
    public static long dateDiffDateTime(long startTime,long endTime) throws ParseException {
        SimpleDateFormat df = new SimpleDateFormat(DateUtil.DATE_TIME_FORMAT);
     ...
     *
     */
    public static long getDayByMinusDate(Object fromDate, Object toDate) throws ParseException {
     ...
     * @return
     */
    public static Date chgObject(Object date) throws ParseException {
